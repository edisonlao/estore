...
guide{
  ...
  <input type="hidden" id="msg" value="${msg }"/>
	<center>	
	    <iframe width="100%" height="30px" frameborder="0" src="index/top.jsp"  scrolling="no">
	    
	    </iframe>
		
		<iframe id="guide" width="27.3%" height="150px" frameborder="0" src="index/mainguide.jsp" scrolling="no" style="background-color:rgba(255,255,255,0);margin-left:700px; position:absolute;z-index: 999" >
