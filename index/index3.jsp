...
guide{
  ...
  <body>
	...
	<center>	
	    <iframe width="100%" height="30px" frameborder="0" src="index/top3.jsp?username=${username }&id=${id }"  scrolling="no">
	    
	    </iframe>
		
		<iframe id="guide" width="27.3%" height="150px" frameborder="0" src="index/guide2.jsp?username=${username }&id=${id }" scrolling="no" style="background-color:rgba(255,255,255,0);margin-left:700px; position:absolute;z-index: 999" >
	    ...
	    <iframe id="commodity" frameborder="0" style="display: none;border: 1px;border-style: solid" width="80%" height="1000px" src="index/commodity/index2.jsp?msg=${msg }" >
