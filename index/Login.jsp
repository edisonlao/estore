...
<html>
  <head>
    ...
    span{
 	...
 	body{
 		background:url("index/pic/Login.png") no-repeat;
 	}
 	div{
...
-webkit-box-shadow: 0 0 0px 1000px white inset;
  ...
  <body>
    		...
    		<br>
    			...
    			<tr>
    				<td><input type="text" id="username" name="username"  value="" onblur="zhanghao()"/></td>
    				...
    				<td id="r1" >
    					&nbsp;
    					<input type="radio" name="role" value="0"/><span>管理员</span>
    					<input type="radio" name="role" value="1"/><span>买&nbsp;家</span>
    					<input type="radio" name="role" value="2"/><span>卖&nbsp;家</span>
    				</td>
    				</tr>
    				<tr >
    				...
    				<td>
    					<center>
    						<input id="sumit" type="submit" name="submit" value="" onclick="zhanghao()" />
    					</center>
    				</td>
    					</tr>
    			</table>
